...
/datum/species/anthromorph
	...
	base_name = "Beastvolk"
	use_titles = TRUE
	race_titles = list("Cat-Kin", "Dog-Kin", "Wolf-Kin", "Lion-Kin", "Venard-Kin", "Tiger-Kin", "Sheep-Kin", "Goat-Kin", "Rous-Kin", "Possum-Kin", "Pig-Kin", "Boar-Kin", "Rabbit-Kin", "Horse-Kin", "Hyena-Kin", "Deer-Kin", "Bear-Kin", "Panda-Kin", "Coyote-Kin", "Jackal-Kin", "Panther-Kin", "Lynx-Kin", "Seal-Kin", "Bat-Kin", "Otter-Kin", "Cow-Kin", "Bull-Kin", "Monster-Kin")
